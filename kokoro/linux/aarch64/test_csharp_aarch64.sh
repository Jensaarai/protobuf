...
CSHARP_BUILD_COMMAND="dotnet publish -c Release -f net5.0 csharp/src/Google.Protobuf.Test/Google.Protobuf.Test.csproj"
...
CSHARP_TEST_COMMAND="dotnet vstest csharp/src/Google.Protobuf.Test/bin/Release/net5.0/publish/Google.Protobuf.Test.dll"
